...
def pd_from_json(file):
    ...
    for i in json_data:
        if 'antisemitism_rating' in i and 'description' in i['user']:
            pre_panda_data.append([i['antisemitism_rating'],i['user']['description']])
        else:
...
if __name__ == "__main__":
    ...
    data,unlabeled=pd_from_json("hackathon.json")
    ...
    pipeline= Pipeline([('vect', CountVectorizer()),('tfidf', TfidfTransformer()),('nb', SGDClassifier(loss='hinge')),])
